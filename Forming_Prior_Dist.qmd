...
comp_mod_match_state <- comp_glm(server_won ~ -1, data = match_state_df,
                                  p1 = "player1", p2 = "player2",
                                  p1_effects = ~ p1_server, p2_effects = ~ p2_server,
                                  ref_player = "Carlos Alcaraz")

prior_dist_df <- comp_mod_match_state |>
  broom::tidy() |>
  print(n = Inf)
# view output
prior_dist_df
...
Pull data from points csv similar to alcaraz v sinner
