...
ggplot(data = both_priors_df, aes(x = prob)) +
  ...
  labs(title = "Prior Distributions for Sinner and Alcaraz",
       x = "Probability of Winning a Point (on serve)",
       y = "Density",
       caption = "Prior includes matches from leadup tournaments to 2022 USO and USO itself") +
...
## Case Study 1: Alcaraz vs Sinner
  ...
  * Win probabilities on serve at the start of the match:
    * $p_{alcaraz} = 0.6229$
    * $p_{sinner} = 0.5606$
...
plot_sin_alc_small_prior |> ggplot(aes(x = pt_number, y = probability)) +
  ...
  annotate("text", x = 110, y = 0.15, 
           label = "Small Prior: Alcaraz = 0.5606, Sinner = 0.6229", size = 3.5, color = "black") +
  annotate("text", x = 110, y = 0.1, 
           label = "Large Prior: Alcaraz = 0.6176 Sinner = 0.6056", size = 3.5, color = "black") +
  annotate("text", x = 110, y = 0.05, 
           label = "Fixed Probability: Alcaraz = 0.68, Sinner = 0.68", size = 3.5, color = "black")
```
